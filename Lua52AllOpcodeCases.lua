...
--
-- This script exercises all opcodes in the Lua 5.2 VM (40 total).
-- It is designed to run under a Lua 5.2 interpreter and print
-- "PASSED" if everything completes without error.
--
-- Lua 5.2 removes GETGLOBAL/SETGLOBAL from 5.1, replacing them
-- with GETTABUP/SETTABUP (globals are accessed through the _ENV
-- upvalue).  It also adds LOADKX/EXTRAARG for large constant pools.
--
-- Opcode checklist (40):
--   MOVE, LOADK, LOADKX(*), LOADBOOL, LOADNIL,
--   GETUPVAL, GETTABUP, GETTABLE, SETTABUP, SETUPVAL,
--   SETTABLE, NEWTABLE, SELF, ADD, SUB, MUL, DIV, MOD, POW,
